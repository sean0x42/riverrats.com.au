...
class PlayerTest < ActiveSupport::TestCase
  ...
  test 'invalid with blank username' do
    ...
    assert_not_empty player.errors[:username], 'No validation error present '\
                                               'for player without a username'
  end
  ...
  test 'invalid with blank first name' do
    ...
    assert_not_empty player.errors[:first_name], 'No validation error present '\
                                                 'for player without a first '\
                                                 'name'
  end
  ...
  test 'invalid with blank last name' do
    ...
    assert_not_empty player.errors[:last_name], 'No validation error present '\
                                                'for player without a last '\
                                                'name'
  end
  ...
  test 'invalid with long nickname' do
    ...
    assert_not_empty player.errors[:nickname], 'No validation error present '\
                                               'for player with long nickname'
  end
end
